  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-pink-100 rounded-full opacity-40 animate-blob animation-delay-2000"></div>
        ...
        <div className="absolute bottom-20 right-10 w-28 h-28 bg-green-100 rounded-full opacity-35 animate-blob"></div>
